...
Component library: `@base/ui` (Base UI + StyleX + motion). Optional 3D: `@base/canvas` (R3F + drei + DialKit). GPU backgrounds: `@base/shaders` (OGL + compound `Shader` API; see `docs/adr/0001-shaders-package-route.md`).
