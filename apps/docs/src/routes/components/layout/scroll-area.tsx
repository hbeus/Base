...
function PageComponent() {
  ...
  return (
    <DocsPage
      title='Scroll Area'
      description='Custom scrollbar overlay with viewport, scrollbar, and thumb. Scroll-aware edge fade is on by default (scrollFade={false} to disable) — see Utilities → Scroll Fade for the CSS classes. Put surface/background on Root or a parent — the mask dissolves the Viewport, including any background painted on it or its children.'
    >
      <ComponentExample
